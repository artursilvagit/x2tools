...
botaoEnviar.addEventListener("click", () => {
    paragrafoResultado.textContent = `Com base nos dados fornecidos, sua margem de lucro é ${(Number(inputLucro.value) / Number(inputValorVenda.value) * 100).toFixed(2) || 0}%`
